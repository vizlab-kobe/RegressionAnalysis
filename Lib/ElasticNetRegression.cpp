#include "ElasticNetRegression.h"
...
template <typename T>
void ElasticNetRegression<T>::fit( const kvs::ValueArray<T>& dep, const kvs::ValueTable<T>& indep )
{
...
template class ElasticNetRegression<float>;
